...
ClassicalKeywords
    ...
    ${var2}=    Multiply Integer by 2 (differently)    ${var1}
    ${var3}=    Multiply two given variables    ${var1}    ${var2}
    @{list}=    Create custom list    3    4
...
Multiply Integer by 2 and resert if over 8
    ...
    ...    ELSE    Set Variable    0
    ${log_level}    Set Variable if    ${var1} == 8    WARN INFO
...
Multiply Integer by 2 (differently)
    [Arguments]    ${input_integer}
    ${converted_input}    Convert To Integer    ${input_integer}
    ${output}=    Evaluate    ${converted_input} * 2
    [Return]    ${output}
...
Multiply two given variables
    ...
    ${output}=    Evaluate    ${converted_input1} * ${input_integer2} * ${input_integer3}
    [Return]    ${output}
